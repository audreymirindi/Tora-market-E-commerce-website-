...
/* $user_unique_id = $_SESSION['user_unique_id_session']; */
$user_unique_id = "111";
...
if (
    ...
    $execution = $query->execute([$marque, $description, $prix, $categorie, $sous_categorie, $Localisation, $etat_produit, $nombre_de_vues, $unique_id, $Livraison, $nombre_produit, $currency, "disabled", $seo_url, $user_unique_id]);
    if ($execution) {
        for ($i = 0; $i < $total; $i++) {
